...
Guidelines](http://drive.google.com/open?id=1V--1-XZI7pv9DJ9Kc8NK-O4sOOISWo0hz__rqGEw_jU)
...
### Repository City:
Name of the city *only*, do not include the name of
the state

### Holding Institution:
Name of the institution above the
...
### Call Number/ID:
Will vary from institution to institution. Use what
is provided by the institution.

### Manuscript Name:
Use names provided by institution. When supplying a
name, do so in English.

### Authors:
Preference is to put the **Authority name:** Common name --
...
Same rules as **Author** fields
above

### Provenance:
In this field the whole known history of the manuscript
...
### Date (narrative):
Enter the phrase as given in this row and supply
...
### Place of Origin:
This should be a modern geographical location
...
### Description:
Each **Description** should, in a **maximum of 250
...
### Language:
Name of the language or languages represented in the
...
How the leaves or pages of the manuscript are
...
### Flyleaves & Leaves:
Formula showing the numbers of flyleaves and
...
### Layout:
The easiest layout details to capture are number of columns
...
### Colophon:
Transcription of the colophon, if present. Any other
information about a colophon should be a **Note**.

### Collation:
There are three options for values for the collation
...
[https://biblio-philly-collations.herokuapp.com/](https://biblio-philly-collations.herokuapp.com/)
...
### Script:
Information about the type of lettering used in the
...
- Gothic\--textualis (everything below semi-quadrata; 
for Gothic with single-compartment *a*, sometimes called semitextualis, add a note: 
...
### Catchwords:
If catchwords are present, where are they found, and
...
### Signatures:
If they are using a system in which quires are marked
progressively, rather than using catchwords, you can explain that here.
Same rules apply as for catchwords.

### Note(s):
Additional information about the manuscript that does not
...
### Related resource:
For Bibliographic citations, use the **modified
...
### INC and EXP:
Include only for works where they are especially
...
### DECO:
Brief description of the decoration or illustration. If there
