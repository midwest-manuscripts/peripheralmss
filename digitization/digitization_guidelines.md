...
2. After items are digitized and visually checked by the scanning institution (section above) correctly named and foldered files are uploaded to the designated server address.
    ...
    3. [Look for your three letter institution code](https://docs.google.com/spreadsheets/d/1_McjMl3VEekWd6_m50fCdN3uZBWsYUXI/edit?usp=sharing&ouid=103792042951858873735&rtpof=true&sd=true)(view-only)
